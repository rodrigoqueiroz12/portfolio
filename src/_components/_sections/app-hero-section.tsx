  ...
  return (
    <section>
      ...
      <p className="font-figtree mb-6 max-w-[600px] leading-paragraph text-bistre-800">
        ...
        <strong>React</strong>, <strong>Node</strong> e <strong>Laravel</strong>
        . Estou em constante evolução, buscando aprimorar minhas habilidades e
        acompanhando as tendências mais inovadoras da área. Espero que goste de
        me conhecer!
      </p>
